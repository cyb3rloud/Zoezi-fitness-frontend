  ...
  return (
    <>
      <div className="wrapper">
        ...
        <div className="scroll">
          <h3>
            "So that the monotonous fall of the waves on the beach, which for the most part beat a measured and soothing
            tattoo to her thoughts seemed consolingly to repeat over and over again."
          </h3>
        </div>
